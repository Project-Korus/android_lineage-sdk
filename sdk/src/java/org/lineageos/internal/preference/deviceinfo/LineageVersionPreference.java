...
public class LineageVersionPreference extends SelfRemovingPreference
    ...
    private static final String KEY_KORUS_VERSION_PROP = "ro.korus.version";
    ...
    public void onAttached() {
        ...
        setTitle(R.string.korus_version);
        setSummary(SystemProperties.get(KEY_KORUS_VERSION_PROP,
